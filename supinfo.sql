...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 04 Décembre 2015 à 20:02
...
CREATE TABLE IF NOT EXISTS `tripHistory` (
  `ID` int(11) NOT NULL,
  `DepartureCampusID` int(11) NOT NULL,
  `DestinationCampusID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  `IDBooster` mediumint(9) NOT NULL,
  `FamilyName` varchar(255) NOT NULL,
  `Name` varchar(255) NOT NULL,
  `Email` text NOT NULL,
  `CampusID` mediumint(9) NOT NULL,
  `CurrentSchoolYear` tinyint(1) NOT NULL,
